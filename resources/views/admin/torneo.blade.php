...
@section('content')
                    ...
                    <div class=" panel-body">
                        <div class="table-responsive">
                            <table id="editar"  class=" table table-bordered table-condensed table-hover">
                                ...
                                @foreach($torneo->TarjetasEquipos() as $t)
                                    <tr >
    ...
    <div class="modal fade" id="modalZonaEliminar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!!Form::open(['route'=>['admin.zonas.destroy'],'method'=>'DELETE'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="myModalLabel">Eliminando Zona</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            {!!Form::Text('idzona',null,['class'=>'hidden','id'=>'idzonaD'])!!}
                            <h3>¿Desea Eliminar la Zona?</h3>
                            <div >
                                <p>Para eliminar la zona, la misma no debe tener fechas cargadas. Antes de Eliminar la Zona elimine sus fechas</p>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        $(function () {
            ...
            $('body').on('click', '.eliminar', function (event) {
                event.preventDefault();
                var id_arbitro=$(this).attr('data-idzona');
                $("#idzonaD").val(id_arbitro);
                $("#modalZonaEliminar").modal("show");
            });
