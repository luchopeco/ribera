                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            @if($partido->Fecha->es_play_off==1)
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">Penales</span>
                                                                    {!!Form::Number('penales_local',$partido->penales_local,['class'=>' form-control','placeholder'=>'Penales','title'=>'Penales', 'required'])!!}
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            @if($partido->Fecha->es_play_off==1)
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">Penales</span>
                                                                    {!!Form::Number('penales_visitante',$partido->penales_visitante,['class'=>' form-control','placeholder'=>'Penales','title'=>'Penales', 'required'])!!}
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
