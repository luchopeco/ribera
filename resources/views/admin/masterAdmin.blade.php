    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li <?php if('torneo\Http\Controllers\Admin\Reportes'== substr(\Illuminate\Support\Facades\Route::getCurrentRoute()->getActionName(),0,-16)){echo 'class="active"';} ?>><a href="/admin/reportes"><i class="fa fa-file-text-o" aria-hidden="true"></i>Reportes</a></li>
                <li><a href="#">
