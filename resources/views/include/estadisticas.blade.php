                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-10">
                                        <h3 style="color:#ffffff">SANCIONADOS</h3>
                                    </div>
                                </div>
                                @foreach($torneo->listZonas as $zona)
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" style="">
                                        ...
                                        <div class="fechas-wrapper col-fechas">
                                            ...
                                            <div class="table-responsive">
                                                <table class=" table goleadores">
                                                    ...
                                                    <?php ?>
                                                    @foreach($zona->Sancionados() as $goleador)
                                                        <tr>
                                                            <td>{{$goleador->jugador}}</td>
                                                            <td>{{$goleador->nombre_equipo}}</td>
                                                            <td>{{$goleador->fechas_restantes}}</td>
...
<div class="portfolio-modal modal fade" id="torneo{{$torneo->idtorneo}}" tabindex="-1" role="dialog" aria-hidden="true" style="padding-right: 0px !important;">
    <div class="modal-content">
        ...
        <div class="container">
            <div class="modal-body">
                <div class="col-md-12">
                    <img src="/imagenes/{{$torneo->imagen}}"  >
                </div>
            </div>
        </div>
    </div>
